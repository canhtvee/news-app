...
class HeadlineRepository @Inject constructor(
    ...
    fun getBusinessHeadline() = performGetOperation2(
        ...
        getDataFromLocalSource = { articleLocalDataSource.loadByContent(sourcePlanning.businessSources) }
    ...
    fun getTechHeadline() = performGetOperation2(
        ...
        saveDataToDatabase = { articleLocalDataSource.insert(it) },
        getDataFromLocalSource = { articleLocalDataSource.loadByContent(sourcePlanning.techSources) }
    ).flowOn(Dispatchers.IO)
    ...
    fun getStartupHeadline() = performGetOperation2(
        ...
        saveDataToDatabase = { articleLocalDataSource.insert(it) },
        getDataFromLocalSource = { articleLocalDataSource.loadByContent(sourcePlanning.startup) }
    ).flowOn(Dispatchers.IO)
    ...
    fun getScienceHeadline() = performGetOperation2(
        ...
        saveDataToDatabase = { articleLocalDataSource.insert(it) },
        getDataFromLocalSource = { articleLocalDataSource.loadByContent(sourcePlanning.scienceSources) }
    ).flowOn(Dispatchers.IO)
    ...
    fun getLifeHeadline() = performGetOperation2(
        ...
        saveDataToDatabase = { articleLocalDataSource.insert(it) },
        getDataFromLocalSource = { articleLocalDataSource.loadByContent(sourcePlanning.lifeSources) }
    ).flowOn(Dispatchers.IO)
